			...
			if ( Character.isLetter((char) ch)) {
				...
				while ( ch != ')' ) {
					if ( inputArrayIndex < inputArray.length ) {
						...
						System.out.println("");
						System.out.println("1 short of EOS in paren at pos: " + inputArrayIndex + " of " + inputStr );
						break;
					}
					Character Ch = new Character((char) ch);
					//outputStr += Ch.toString();
				...
				*/
				...
				outputStr += Ch.toString();
				System.out.println( Ch.toString() );
				System.out.println("found close paren at position: " + inputArrayIndex + " of input term " + inputStr );
