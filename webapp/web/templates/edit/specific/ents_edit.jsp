...
<c:if test="${loginHandler.loginRole >= 4}">
	...
	<table class="form-background" border="0" cellpadding="2" cellspacing="2" width="100%">
    	...
    	<td>
        	...
        	<form action="cloneEntity" method="post">
        		Name for new clone of this Individual:<br/><input type="text" name="name" size="40" maxlength="254" value=""/><br/>
        		Time (yyyy-mm-dd hh:mm): <input type="text" name="timekey" size="12" maxlength="19"/> (24h)<br/>
            	<input type="submit" class="form-button" value="Clone this Individual"/>
            	<input type="hidden" name="home" value="${portalBean.portalId}" />
				<input type="hidden" name="uri" value="${individual.URI}" />
        	</form>
