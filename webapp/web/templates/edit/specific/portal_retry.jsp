...
<c:set var="appNameLabel" value="${( singlePortal && ! creatingNewPortal ) ? 'Site Name' : 'Portal Application Name'}"/> 

<c:set var="smallCell" value="style='width: 33%;'" />
<c:set var="longInput" value="style='width: 85%;'" />
 
<tr class="editformcell">
    <td valign="top" colspan="1">
        <b>${appNameLabel}</b> <i>(max 50 characters)</i><br />
            <input type="text" name="AppName" value="<form:value name="AppName"/>" ${longInput} maxlength="50" />
            <font color="red"><form:error name="AppName"/></font>
    </td>

    <c:if test="${ ! singlePortal || creatingNewPortal}">
        <td valign="top" colspan="1">
...
<tr class="editformcell">
    <td valign="top" colspan="1">
        ...
        <input type="text" name="ShortHand" value="<form:value name="ShortHand"/>" ${longInput} maxlength="50" />
...
<tr class="editformcell">
    <td valign="bottom" colspan="1">
        ...
        <input type="text" name="ContactMail" value="<form:value name="ContactMail"/>" ${longInput} maxlength="255" />
...
<tr class="editformcell">
    ...
    <td valign="bottom" colspan="1">
        <b>Image thumb width</b><br />
        <input type="text" name="ImageThumbWidth" value="<form:value name="ImageThumbWidth"/>" ${smallCell} maxlength="11" />
        <font color="red"><form:error name="ImageThumbWidth"/></font>
    </td>
</tr>
<tr class="editformcell">
    <td valign="bottom">
        <b>Copyright text</b> <i>used in footer (e.g., name of your institution)</i><br />
        <input type="text" name="CopyrightAnchor" value="<form:value name="CopyrightAnchor"/>" ${longInput} maxlength="120" />
...
<tr class="editformcell">
    <td valign="bottom">
        ...
        <input type="text" name="CopyrightURL" value="<form:value name="CopyrightURL"/>" ${longInput} maxlength="120" />
